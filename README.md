...
# Дипломная работа Стариковой О. Ю. по курсу "Нетологии" "Frontend-разработчик"

## Стек технологий:



*   **Frontend Core:** React.js (функциональные компоненты, Hooks), TypeScript (строгая типизация, интерфейсы), HTML5/CSS3.
*   **Сборка и разработка:** Vite (быстрая сборка).
...
[https://olgastar-555.github.io/diplom/](https://olgastar-555.github.io/diplom/)
